...
> **توجه:** در حالی که این راهنما مرور امن در «اینترنت عادی» (Clearnet) را پوشش می‌دهد، برای فعالیت‌های پرخطر که نیاز به ناشناسی کامل دارند، باید حتماً از **مرورگر تور (Tor Browser)** استفاده کنید. لطفاً به راهنمای [تور و شبکه‌های ناشناسی](Tor_and_Anonymity_Networks.md) مراجعه کنید.
