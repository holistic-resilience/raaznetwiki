...
other_languages:
  en: "/en/wiki/data-management/data-storage/backup-and-recovery-strategies"
---
...
اگر در خطر فوری یورش هستید، ممکن است نیاز باشد داده‌هایتان را به جای ذخیره کردن، نابود کنید. لطفاً برای دستورالعمل‌های پاک‌سازی درایوها و نابودی فیزیکی رسانه‌ها به صفحه **[Secure_Data_Deletion](../امحا-و-حذف-امن-دادهها)** مراجعه کنید.
