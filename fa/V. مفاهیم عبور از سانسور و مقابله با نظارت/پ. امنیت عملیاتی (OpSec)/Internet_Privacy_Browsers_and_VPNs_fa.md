...
other_languages:
  en: "/en/wiki/circumvention-and-counter-surveillance-concepts/operational-security-opsec/internet-privacy-browsers-and-vpns"
---
...
- **عدم ذخیره رمزهای عبور:** مرورگرها گاوصندوق امن نیستند. به جای ذخیره سازِ داخلی مرورگر، از یک [مدیریت کننده رمز عبور](../../مبانی-فنی/احراز-هویت-و-کنترل-دسترسی/secure-password-storage-and-managers) اختصاصی (مانند KeePassXC یا Bitwarden) استفاده کنید.
