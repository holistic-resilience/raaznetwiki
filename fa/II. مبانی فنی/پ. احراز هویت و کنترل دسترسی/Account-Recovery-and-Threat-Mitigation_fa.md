...
other_languages:
  en: "/en/wiki/technical-foundations/authentication-and-access-control/account-recovery-and-threat-mitigation"
---
...
- **حملات جستجوی فراگیر (Brute-Force Attacks):** حتی بدون شنود مستقیم یا کپی‌سازی سیم‌کارت، آسیب‌پذیری‌ها در سیستم‌های بازنشانی رمز عبور می‌توانند به مهاجمان اجازه دهند تا با دور زدن محدودیت‌های نرخ (Rate Limits) با استفاده از هزاران آدرس IP، کدهای بازیابی ۶ رقمی پیامکی را با جستجوی فراگیر حدس بزنند، همانطور که در مورد اینستاگرام نشان داده شد.
