...
other_languages:
  en: "/en/wiki/platform-and-device-knowledge/communication-platforms/whatsapp-security-guide"
---
...
### نام‌های کاربری (ویژگی در راه)

واتس‌اپ در حال معرفی نام‌های کاربری اختیاری است که به کاربران امکان می‌دهد بدون به اشتراک گذاشتن شماره تلفن خود با یکدیگر ارتباط برقرار کنند. این می‌تواند یک بهبود قابل توجه در حریم خصوصی باشد، به خصوص برای مخاطبین جدید یا در گروه‌های عمومی، زیرا میزان افشای شماره تلفن شخصی شما را کاهش می‌دهد.

**نحوه رزرو نام کاربری واتس‌اپ شما (هنگامی که در دسترس باشد):**

1.  واتس‌اپ را به آخرین نسخه به‌روزرسانی کنید.
2.  **تنظیمات (Settings)** را باز کنید.
3.  به **حساب کاربری (Account)** بروید.
4.  روی **نام کاربری (Username)** ضربه بزنید.
5.  یک نام کاربری موجود را انتخاب کنید.
6.  انتخاب خود را تایید کنید.

**ملاحظات امنیتی برای نام‌های کاربری:**

*   **جعل هویت:** مراقب مهاجمانی باشید که سعی می‌کنند نام‌های کاربری شبیه به افراد یا برندهای قانونی را ثبت کنند.
*   **حساب‌های پشتیبانی جعلی:** کلاهبرداران ممکن است نام‌های کاربری ایجاد کنند که وانمود می‌کنند بانک‌ها، شرکت‌های تحویل کالا یا سازمان‌های دولتی هستند. همیشه درخواست‌ها را از طریق کانال‌های رسمی تایید کنید.
*   **جمع‌آوری نام کاربری:** اگر نام کاربری خود را در رسانه‌های اجتماعی منتشر کنید، به یک شناسه دیگر تبدیل می‌شود که کلاهبرداران می‌توانند آن را جمع‌آوری کنند. استفاده از یک نام کاربری منحصر به فرد که به سایر حساب‌های رسانه‌های اجتماعی شما مرتبط نیست را در نظر بگیرید.
*   **کلید نام کاربری:** واتس‌اپ همچنین در حال معرفی یک «کلید نام کاربری» اختیاری برای یک لایه اضافی از تایید است که کنترل بیشتری بر اینکه چه کسی می‌تواند تماس را آغاز کند، می‌دهد.
