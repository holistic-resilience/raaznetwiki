...
tags: [passwords, authentication, account-security, privacy, security]
category: "Passwords"
difficulty: "Beginner"
audience: [General Public, Journalists, Human Rights Defenders, Civil Society Organizations]
topics: ["Password Hygiene", "Account Protection"]
summary: "Best practices for creating strong passphrases, using password managers and 2FA, and avoiding common mistakes that lead to account compromise."
...
Passwords › Create and maintain strong passwords

# [Anchor](https://securityinabox.org/en/passwords/passwords/#create-and-maintain-strong-passwords) Create and maintain strong passwords

Updated 28 March 2024

## [Anchor](https://securityinabox.org/en/passwords/passwords/#table-of-contents) Table of Contents

- [Protect your passwords](https://securityinabox.org/en/passwords/passwords/#protect-your-passwords)
- [Create a stronger password](https://securityinabox.org/en/passwords/passwords/#create-a-stronger-password)
- [Remember a few secure passwords](https://securityinabox.org/en/passwords/passwords/#remember-a-few-secure-passwords)
- [If you need to share passwords](https://securityinabox.org/en/passwords/passwords/#if-you-need-to-share-passwords)
- [Find out if your passwords have been compromised](https://securityinabox.org/en/passwords/passwords/#find-out-if-your-passwords-have-been-compromised)
- [Be aware of how attackers can guess your passwords](https://securityinabox.org/en/passwords/passwords/#be-aware-of-how-attackers-can-guess-your-passwords)
- [Do not give your password when someone emails, calls, or messages you](https://securityinabox.org/en/passwords/passwords/#do-not-give-your-password-when-someone-emails-calls-or-messages-you)
- [When to change your password](https://securityinabox.org/en/passwords/passwords/#when-to-change-your-password)
- [Mind where you are and who can see you typing a password](https://securityinabox.org/en/passwords/passwords/#mind-where-you-are-and-who-can-see-you-typing-a-password)
- [Avoid fingerprint or face unlock (biometrics)](https://securityinabox.org/en/passwords/passwords/#avoid-fingerprint-or-face-unlock-biometrics)
- [Consider how and when to use passkeys](https://securityinabox.org/en/passwords/passwords/#consider-how-and-when-to-use-passkeys)
- [Set safer recovery questions](https://securityinabox.org/en/passwords/passwords/#set-safer-recovery-questions)
- [Further reading](https://securityinabox.org/en/passwords/passwords/#further-reading)
...
## [Anchor](https://securityinabox.org/en/passwords/passwords/#protect-your-passwords) Protect your passwords

- Always use a secure, updated, protected and trusted device to access your accounts and manage your sensitive information, including passwords. Read the guides on [Phones and Computers](https://securityinabox.org/en/phones-and-computers/) to learn how to make sure your device is secure.
- Use a password manager. No human brain is powerful enough to develop and remember passwords that are sufficiently long, random and unique to keep all of their devices and accounts secure. A password manager generates and stores these passwords for you, protecting them with encryption. Learn more on what password managers you can use and how to use them in [our guide on password managers](https://securityinabox.org/en/passwords/password-managers).
- Use two-factor authentication (2FA or MFA). Two-factor authentication (2FA), also called multi-factor authentication (MFA) adds a second factor of authentication to your login system. By using 2FA, you can make sure that even if someone manages to guess your password, they cannot log in because they still need a second factor which is harder to get. To learn how to use 2FA in the safest way, read [our guide on two-factor authentication](https://securityinabox.org/en/passwords/2fa).

Read the following sections to learn more about how to protect your passwords and accounts from the most common attacks.

## [Anchor](https://securityinabox.org/en/passwords/passwords/#create-a-stronger-password) Create a stronger password

In a nutshell, we suggest to create all the passwords you need with an [offline password manager](https://securityinabox.org/en/passwords/password-managers) and to just have [few longer passphrases that you can remember](https://securityinabox.org/en/passwords/passwords/#remember-a-few-secure-passwords) to unlock the device where you have installed your password manager and the password manager database.
...
- Remember that you don't have to change your passwords frequently. To decide when to change a password, read [When to change your password](https://securityinabox.org/en/passwords/passwords/#when-to-change-your-password).

## [Anchor](https://securityinabox.org/en/passwords/passwords/#remember-a-few-secure-passwords) Remember a few secure passwords
...
## [Anchor](https://securityinabox.org/en/passwords/passwords/#if-you-need-to-share-passwords) If you need to share passwords
...
- Avoid sharing passwords whenever possible:
  ...
  - If you need to share access to your device, consider creating a separate account for that device. See the basic security guides for [Android](https://securityinabox.org/en/phones-and-computers/android/#create-separate-user-accounts-on-your-devices), [Linux](https://securityinabox.org/en/phones-and-computers/linux/#create-separate-user-accounts-on-your-devices), [macOS](https://securityinabox.org/en/phones-and-computers/mac/#create-separate-user-accounts-on-your-devices), and [Windows](https://securityinabox.org/en/phones-and-computers/windows/#create-separate-user-accounts-on-your-devices) for instructions on how to do this.
      - On iOS devices this option is not available, unless you are using an iPad. See [Shared iPad overview](https://securityinabox.org/en/phones-and-computers/mac/#create-separate-user-accounts-on-your-devices) to learn how this works.
...
## [Anchor](https://securityinabox.org/en/passwords/passwords/#find-out-if-your-passwords-have-been-compromised) Find out if your passwords have been compromised

- Search [the ';--have i been pwned? website](https://haveibeenpwned.com/) to see if your accounts are reported as compromised.
  - Change any of your account passwords you find there immediately, following the instructions for [using a password manager](https://securityinabox.org/en/passwords/password-managers/#use-a-password-manager-installed-in-your-device).
...
## [Anchor](https://securityinabox.org/en/passwords/passwords/#be-aware-of-how-attackers-can-guess-your-passwords) Be aware of how attackers can guess your passwords
...
3. They can trick you into:
   ...
   - Providing your passwords or other information by pretending to be a support person or someone you know (also known as social engineering).
     - Read more on how to recognize attempts at pressuring you to act quickly or appeal to your emotions in [our guide on malware](https://securityinabox.org/en/phones-and-computers/malware/#be-aware-that-malicious-actors-may-try-to-pressure-you-to-act-quickly-or-appeal-to-your-emotions).
...
## [Anchor](https://securityinabox.org/en/passwords/passwords/#do-not-give-your-password-when-someone-emails-calls-or-messages-you) Do not give your password when someone emails, calls, or messages you

- Go to the app or site for the service that supposedly sent you the message to verify the request.
  - See our guides on [protecting yourself and your data when using social media](https://securityinabox.org/en/communication/social-media/) to find the records of alerts different services may have sent you.
...
## [Anchor](https://securityinabox.org/en/passwords/passwords/#when-to-change-your-password) When to change your password
...
See [our guide on social media](https://securityinabox.org/en/communication/social-media/) and the basic security guides for [Android](https://securityinabox.org/en/phones-and-computers/android/#set-your-screen-to-sleep-and-lock), [iOS](https://securityinabox.org/en/phones-and-computers/ios/#set-your-screen-to-sleep-and-lock), [Linux](https://securityinabox.org/en/phones-and-computers/linux/#set-your-screen-to-sleep-and-lock), [macOS](https://securityinabox.org/en/phones-and-computers/mac/#set-your-screen-to-sleep-and-lock), and [Windows](https://securityinabox.org/en/phones-and-computers/windows/#set-your-screen-to-sleep-and-lock) for instructions on how to change the password of your device.
...
## [Anchor](https://securityinabox.org/en/passwords/passwords/#mind-where-you-are-and-who-can-see-you-typing-a-password) Mind where you are and who can see you typing a password
...
## [Anchor](https://securityinabox.org/en/passwords/passwords/#consider-how-and-when-to-use-passkeys) Consider how and when to use passkeys
...
## [Anchor](https://securityinabox.org/en/passwords/passwords/#set-safer-recovery-questions) Set safer recovery questions
...
## [Anchor](https://securityinabox.org/en/passwords/passwords/#further-reading) Further reading
