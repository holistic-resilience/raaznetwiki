...
tags: [identity, pseudonymity, anonymity, privacy, security, threat-modeling]
category: "Assess & Plan"
difficulty: "Intermediate"
audience: [Human Rights Defenders, Journalists, Activists, At-Risk Individuals]
topics: ["Operational Security", "Identity Management", "Compartmentalization"]
summary: "Strategy guide for planning, creating, and compartmentalizing multiple online identities to protect sensitive work and personal safety."
source: "Security in a Box"
content_type: "Practical Guide"
security_level: "High-Risk"
language: "English"
prerequisites: ["Basic digital security concepts", "Comfort using multiple devices or profiles"]
estimated_read_time: "25 minutes"
---

__('Table of Contents')

Assess & Plan › Create and protect multiple online identities

# [Anchor](https://securityinabox.org/en/assess-plan/multiple-identities/#create-and-protect-multiple-online-identities) Create and protect multiple online identities

Updated 9 September 2024

## [Anchor](https://securityinabox.org/en/assess-plan/multiple-identities/#table-of-contents) Table of Contents

- [Develop your strategy](https://securityinabox.org/en/assess-plan/multiple-identities/#develop-your-strategy)
- [Check what information exists already on you online](https://securityinabox.org/en/assess-plan/multiple-identities/#check-what-information-exists-already-on-you-online)
- [Get rid of unwanted information and old identities](https://securityinabox.org/en/assess-plan/multiple-identities/#get-rid-of-unwanted-information-and-old-identities)
- [Map your social domains](https://securityinabox.org/en/assess-plan/multiple-identities/#map-your-social-domains)
- [Create and secure an alternative identity](https://securityinabox.org/en/assess-plan/multiple-identities/#create-and-secure-an-alternative-identity)
- [Keep your identities separate](https://securityinabox.org/en/assess-plan/multiple-identities/#keep-your-identities-separate)
- [Compartmentalize each identity using different devices, profiles or virtual environments](https://securityinabox.org/en/assess-plan/multiple-identities/#compartmentalize-each-identity-using-different-devices-profiles-or-virtual-environments)
- [Use payment methods that won't reveal your official identity](https://securityinabox.org/en/assess-plan/multiple-identities/#use-payment-methods-that-wont-reveal-your-official-identity)
- [Reflect on how to manage your multiple identities in physical spaces](https://securityinabox.org/en/assess-plan/multiple-identities/#reflect-on-how-to-manage-your-multiple-identities-in-physical-spaces)
- [[Advanced] Create a website that cannot be connected to your identity](https://securityinabox.org/en/assess-plan/multiple-identities/#advanced-create-a-website-that-cannot-be-connected-to-your-identity)
...
## [Anchor](https://securityinabox.org/en/assess-plan/multiple-identities/#develop-your-strategy) Develop your strategy

Strategies for maintaining separate identities can range from full transparency to full anonymity.

Depending on your risk, situation, needs and goals, you can choose to [use your official name transparently](https://securityinabox.org/en/assess-plan/multiple-identities/#real-identity), [create an alternative persona with its own name and story](https://securityinabox.org/en/assess-plan/multiple-identities/#persistent-pseudonymity) or [try and hide your identity completely](https://securityinabox.org/en/assess-plan/multiple-identities/#anonymity).
...
### [Anchor](https://securityinabox.org/en/assess-plan/multiple-identities/#real-identity) Real identity
...
If you decide to be transparent about who you are, this doesn't mean that you have to expose all your private life to the internet. You could, for example, use the name and surname in your documents to sign your contributions to media outlets and other websites while using private profiles with a [pseudonym](https://securityinabox.org/en/assess-plan/multiple-identities/#persistent-pseudonymity) on social media and chat groups to communicate with your close friends and family.

What counts in these cases is that you always [apply basic practices to keep your identities separate](https://securityinabox.org/en/assess-plan/multiple-identities/#apply-basic-strategies-to-keep-your-identities-separate).

### [Anchor](https://securityinabox.org/en/assess-plan/multiple-identities/#persistent-pseudonymity) Persistent pseudonymity
...
### [Anchor](https://securityinabox.org/en/assess-plan/multiple-identities/#anonymity) Anonymity
...
[Learn more about the tools and strategies you can use to anonymize your connections, messages and file sharing](https://securityinabox.org/en/internet-connection/anonymity).

### [Anchor](https://securityinabox.org/en/assess-plan/multiple-identities/#comparing-strategies) Comparing strategies
...
- **Anonymity**
  ...
  - Risk: While it can be useful if you want to carry out activities that are sanctioned in your context, anonymity can also be hard to maintain. Choose this option carefully and get informed on [how to use anonymization tools correctly](https://securityinabox.org/en/internet-connection/anonymity).
...
## [Anchor](https://securityinabox.org/en/assess-plan/multiple-identities/#check-what-information-exists-already-on-you-online) Check what information exists already on you online
...
## [Anchor](https://securityinabox.org/en/assess-plan/multiple-identities/#get-rid-of-unwanted-information-and-old-identities) Get rid of unwanted information and old identities
...
## [Anchor](https://securityinabox.org/en/assess-plan/multiple-identities/#map-your-social-domains) Map your social domains
...
## [Anchor](https://securityinabox.org/en/assess-plan/multiple-identities/#create-and-secure-an-alternative-identity) Create and secure an alternative identity

### [Anchor](https://securityinabox.org/en/assess-plan/multiple-identities/#choose-a-name) Choose a name
...
Once you have decided on a name, a surname and a username for your new persona, it's best to do [thorough research to find out if someone else is already using that name](https://securityinabox.org/en/assess-plan/multiple-identities/#check-what-information-exists-already-on-you-online).

### [Anchor](https://securityinabox.org/en/assess-plan/multiple-identities/#get-a-different-phone-number) Get a different phone number
...
### [Anchor](https://securityinabox.org/en/assess-plan/multiple-identities/#hide-your-ip-address) Hide your IP address
...
- [Learn how to choose a trusted VPN](https://securityinabox.org/en/internet-connection/circumvention).
- [Learn how to anonymize your connections with Tor](https://securityinabox.org/en/internet-connection/anonymity).
...
### [Anchor](https://securityinabox.org/en/assess-plan/multiple-identities/#create-a-new-email-account) Create a new email account

You can register a new mail account, create an alias starting from your current email account or, if you don't need a permanent address, you could use a disposable email service. Read more on all these options in [our guide on safe email](https://securityinabox.org/en/communication/secure-email).
...
If you don't want the email provider to trace back your new account to your official identity, use [a tool to hide your IP address](https://securityinabox.org/en/assess-plan/multiple-identities/#hide-your-ip-address) when creating your new email account − and remember always to use the same tool also to check your mail.

## [Anchor](https://securityinabox.org/en/assess-plan/multiple-identities/#keep-your-identities-separate) Keep your identities separate

### [Anchor](https://securityinabox.org/en/assess-plan/multiple-identities/#apply-basic-practices-to-keep-your-identities-separate) Apply basic practices to keep your identities separate
...
- Use [strong and unique passwords](https://securityinabox.org/en/passwords/passwords) and [two-factor authentication](https://securityinabox.org/en/passwords/2fa) for every online account you create.
- [Learn how to reduce the risk of being tracked when browsing the web](https://securityinabox.org/en/internet-connection/safer-browsing).

### [Anchor](https://securityinabox.org/en/assess-plan/multiple-identities/#remove-identifying-information-from-pictures-and-other-files) Remove identifying information from pictures and other files
...
- [Learn how to get rid of data that could reveal personal details](https://securityinabox.org/en/files/destroy-identifying-information/).

### [Anchor](https://securityinabox.org/en/assess-plan/multiple-identities/#use-different-online-accounts-or-even-different-platforms-based-on-your-communication-goals) Use different online accounts, or even different platforms based on your communication goals

Each of your identities should have different accounts on social media and messaging apps, and you should take care to register these accounts [through a different IP](https://securityinabox.org/en/assess-plan/multiple-identities/#hide-your-ip-address), [phone number](https://securityinabox.org/en/assess-plan/multiple-identities/#get-a-different-phone-number) and [mail address](https://securityinabox.org/en/assess-plan/multiple-identities/#create-a-new-email-address) than the ones connected to your main identity.
...
### [Anchor](https://securityinabox.org/en/assess-plan/multiple-identities/#keep-your-online-accounts-really-separate) Keep your online accounts really separate
...
- When creating an account for a new persona on a social networking platform, use the [device](https://securityinabox.org/en/assess-plan/multiple-identities/#different-devices), [browser](https://securityinabox.org/en/assess-plan/multiple-identities/#different-browsers) or app you have set up for that persona.
- Make sure to check your account's privacy settings so that you know what you are making public, who can see your posts, who can contact you, who can look you up and what your contacts can do. [Learn how to protect yourself and your data when using social media](https://securityinabox.org/en/communication/social-media).
...
## [Anchor](https://securityinabox.org/en/assess-plan/multiple-identities/#compartmentalize-each-identity-using-different-devices-profiles-or-virtual-environments) Compartmentalize each identity using different devices, profiles or virtual environments
...
### [Anchor](https://securityinabox.org/en/assess-plan/multiple-identities/#computers) Computers
...
- You can get a different computer for each of your identities. Note that these devices have to be able to receive security updates.
  - Check if a device you're thinking of using for your alternative identity will receive security updates in our guides on [Windows](https://securityinabox.org/en/phones-and-computers/windows/#use-the-latest-version-of-your-devices-operating-system-os), [Mac](https://securityinabox.org/en/phones-and-computers/mac/#use-the-latest-version-of-your-devices-operating-system-os) and [Linux](https://securityinabox.org/en/phones-and-computers/linux/#use-the-latest-version-of-your-devices-operating-system-os).

#### Start your computer from a USB disk

- If you need to anonymize all your connections for an alternative identity, a secure tool to do this is [Tails](https://securityinabox.org/en/internet-connection/tools/#tails), a free and open-source operating system that runs from a USB drive, connects to the internet over Tor and leaves no trace on your computer. You can use a different Tails stick for each of your most sensitive identities.
...
- If you don't need to protect your personas against sophisticated attacks or against someone inspecting your devices, you can create a different user account for each of your identities.
  - Learn how to create different user accounts in [Windows](https://securityinabox.org/en/phones-and-computers/windows/#create-separate-user-accounts-on-your-devices), [Mac](https://securityinabox.org/en/phones-and-computers/mac/#create-separate-user-accounts-on-your-devices) and [Linux](https://securityinabox.org/en/phones-and-computers/linux/#create-separate-user-accounts-on-your-devices).
...
- If you only need a browser to manage your alternative identities, you can use a different browser than the one you usually use for your main identity.
  - [Learn what browsers you can choose in our guide on safer browsing](https://securityinabox.org/en/internet-connection/safer-browsing).
...
### [Anchor](https://securityinabox.org/en/assess-plan/multiple-identities/#phones) Phones
...
- Consider dedicating a separate phone to each of your identities. Note that these devices have to be able to receive security updates.
  - Check if a device you're thinking of using for your alternative identity will receive security updates in our guides on [Android](https://securityinabox.org/en/phones-and-computers/android/#use-the-latest-version-of-your-devices-operating-system-os) and [iOS](https://securityinabox.org/en/phones-and-computers/ios/#use-the-latest-version-of-your-devices-operating-system-os).
...
- If you don't need to protect your personas against sophisticated attacks or against someone inspecting your devices, you can create a different user account in your tablet or phone for each of your identities.
  - Learn how to create different user accounts in [Android](https://securityinabox.org/en/phones-and-computers/android/#create-separate-user-accounts-on-your-devices).
...
## [Anchor](https://securityinabox.org/en/assess-plan/multiple-identities/#use-payment-methods-that-wont-reveal-your-official-identity) Use payment methods that won't reveal your official identity
...
## [Anchor](https://securityinabox.org/en/assess-plan/multiple-identities/#reflect-on-how-to-manage-your-multiple-identities-in-physical-spaces) Reflect on how to manage your multiple identities in physical spaces
...
## [Anchor](https://securityinabox.org/en/assess-plan/multiple-identities/#advanced-create-a-website-that-cannot-be-connected-to-your-identity)[Advanced] Create a website that cannot be connected to your identity
