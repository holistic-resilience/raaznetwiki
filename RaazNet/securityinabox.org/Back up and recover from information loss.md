...
tags: [backup, data-protection, files, security, privacy, disaster-recovery]
category: "Files"
difficulty: "Beginner"
audience: [General Public, Civil Society Organizations, Journalists, Human Rights Defenders]
topics: ["Backup Strategies", "Data Resilience", "Secure Storage"]
summary: "Practical guidance on planning backups, choosing storage options, and recovering lost data to reduce the impact of device loss, theft, or failure."
...
Files › Back up and recover from information loss

# [Anchor](https://securityinabox.org/en/files/backup/#back-up-and-recover-from-information-loss) Back up and recover from information loss

Updated 14 March 2024

## [Anchor](https://securityinabox.org/en/files/backup/#table-of-contents) Table of Contents

- [Recover deleted or lost information](https://securityinabox.org/en/files/backup/#recover-deleted-or-lost-information)
- [Create a backup plan](https://securityinabox.org/en/files/backup/#create-a-backup-plan)
- [Back up the files in your computer to a local device](https://securityinabox.org/en/files/backup/#back-up-the-files-in-your-computer-to-a-local-device)
- [Back up your phone to a local device](https://securityinabox.org/en/files/backup/#back-up-your-phone-to-a-local-device)
- [Consider whether or not you should back up to "cloud" services](https://securityinabox.org/en/files/backup/#consider-whether-or-not-you-should-back-up-to-cloud-services)
- [Back up your email](https://securityinabox.org/en/files/backup/#back-up-your-email)
- [Scan and back up printed documents](https://securityinabox.org/en/files/backup/#scan-and-back-up-printed-documents)
- [Set a backup schedule](https://securityinabox.org/en/files/backup/#set-a-backup-schedule)
- [Practice recovery](https://securityinabox.org/en/files/backup/#practice-recovery)
- [Establish procedures for coworkers](https://securityinabox.org/en/files/backup/#establish-procedures-for-coworkers)
- [Other considerations](https://securityinabox.org/en/files/backup/#other-considerations)
...
## [Anchor](https://securityinabox.org/en/files/backup/#recover-deleted-or-lost-information) Recover deleted or lost information
...
When you delete a file, it disappears from view, but it remains on your device. Even after you empty the Recycle Bin or Trash, files you deleted can usually be found on the hard drive. See [How to destroy sensitive information](https://securityinabox.org/en/files/destroy-sensitive-information) to learn how this can put your security at risk.
...
## [Anchor](https://securityinabox.org/en/files/backup/#create-a-backup-plan) Create a backup plan

To create a backup plan, take the following steps:

### [Anchor](https://securityinabox.org/en/files/backup/#organize-your-information) Organize your information
...
### [Anchor](https://securityinabox.org/en/files/backup/#identify-where-and-what-your-information-is) Identify where and what your information is
...
### [Anchor](https://securityinabox.org/en/files/backup/#define-which-are-primary-copies-and-which-are-duplicates) Define which are primary copies and which are duplicates
...
## [Anchor](https://securityinabox.org/en/files/backup/#back-up-the-files-in-your-computer-to-a-local-device) Back up the files in your computer to a local device
...
Because the files you decide to back up often contain the most sensitive information, it is important that you protect them using encryption. You can learn how to do this in [our guide on how to protect information](https://securityinabox.org/en/files/secure-file-storage).
...
## [Anchor](https://securityinabox.org/en/files/backup/#back-up-your-phone-to-a-local-device) Back up your phone to a local device
...
## [Anchor](https://securityinabox.org/en/files/backup/#consider-whether-or-not-you-should-back-up-to-cloud-services) Consider whether or not you should back up to "cloud" services
...
### [Anchor](https://securityinabox.org/en/files/backup/#protect-your-files-before-you-store-them-on-cloud-services) Protect your files before you store them on cloud services
...
- Alternatively, use [VeraCrypt](https://veracrypt.io/) to create an encrypted volume, then copy it to the cloud.
...
### [Anchor](https://securityinabox.org/en/files/backup/#encrypted-cloud-services) Encrypted cloud services
...
### [Anchor](https://securityinabox.org/en/files/backup/#back-up-to-cloud-services-using-your-devices-built-in-tools) Back up to cloud services using your device's built-in tools
...
## [Anchor](https://securityinabox.org/en/files/backup/#back-up-your-email) Back up your email
...
## [Anchor](https://securityinabox.org/en/files/backup/#scan-and-back-up-printed-documents) Scan and back up printed documents
...
## [Anchor](https://securityinabox.org/en/files/backup/#set-a-backup-schedule) Set a backup schedule
...
## [Anchor](https://securityinabox.org/en/files/backup/#practice-recovery) Practice recovery
...
## [Anchor](https://securityinabox.org/en/files/backup/#establish-procedures-for-coworkers) Establish procedures for coworkers
...
## [Anchor](https://securityinabox.org/en/files/backup/#other-considerations) Other considerations
