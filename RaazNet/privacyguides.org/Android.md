---
title: "Android"
tags: [android, privacy, mobile, custom-roms, security]
category: "Operating Systems"
difficulty: "Beginner"
audience: [General Public, Privacy-Conscious Users]
topics: ["Android Hardening", "De-Googling", "App Alternatives"]
summary: "Guidance on improving privacy on Android devices by avoiding invasive Google services, using custom distributions, and following best practices."
source: "Privacy Guides"
content_type: "Practical Guide"
security_level: "Best Practices"
language: "English"
prerequisites: ["Basic familiarity with Android smartphones"]
estimated_read_time: "7 minutes"
---

[Skip to content](https://www.privacyguides.org/en/android/#our-advice)

![](https://www.privacyguides.org/en/assets/img/cover/android.webp)

# Android

[Edit this page](https://github.com/privacyguides/privacyguides.org/blob/main/docs/android/index.md?plain=1 "Edit this page")
...
[General Android Overview](https://www.privacyguides.org/en/os/android-overview/)
...
[Obtaining Applications](https://www.privacyguides.org/en/android/obtaining-apps/)
...
[General App Recommendations](https://www.privacyguides.org/en/android/general-apps/)
...
[Recommended Distributions](https://www.privacyguides.org/en/android/distributions/)
...
Content blockers which modify the [hosts file](<https://en.wikipedia.org/wiki/Hosts_(file)>) (like AdAway) and firewalls which require root access persistently (like AFWall+) are dangerous and should not be used. They are also not the correct way to solve their intended purposes. For content blocking, we suggest encrypted [DNS](https://www.privacyguides.org/en/dns/) or content blocking functionality provided by a VPN instead. TrackerControl and AdAway in non-root mode will take up the VPN slot (by using a local loopback VPN), preventing you from using privacy-enhancing services such as [Orbot](https://www.privacyguides.org/en/alternative-networks/#orbot) or a [real VPN provider](https://www.privacyguides.org/en/vpn/).
