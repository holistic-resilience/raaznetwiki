[Skip to content](https://www.privacyguides.org/en/os/linux-overview/#security-notes)

[Edit this page](https://github.com/privacyguides/privacyguides.org/blob/main/docs/os/linux-overview.md?plain=1 "Edit this page")
...
[Our Linux Recommendations](https://www.privacyguides.org/en/desktop/)
...
- Use privacy-focused systems such as [Whonix](https://www.privacyguides.org/en/desktop/#whonix) or [Tails](https://www.privacyguides.org/en/desktop/#tails)

### Open-Source Security

It is a [common misconception](https://www.privacyguides.org/en/basics/common-misconceptions/#open-source-software-is-always-secure-or-proprietary-software-is-more-secure) that Linux and other open-source software are inherently secure simply because the source code is available. There is an expectation that community verification occurs regularly, but this isn’t always [the case](https://seirdy.one/posts/2022/02/02/floss-security).
...
Not all Linux distributions are created equal. Our [Linux recommendation page](https://www.privacyguides.org/en/desktop/) is not meant to be an authoritative source on which distribution you should use, but our recommendations _are_ aligned with the following guidelines. These are a few things you should keep in mind when choosing a distribution:
...
The atomic update method can achieve reliability with this model and is used for [distributions](https://www.privacyguides.org/en/desktop/#atomic-distributions) like Silverblue and NixOS. [Adam Šamalík](https://twitter.com/adsamalik) provides a presentation on how `rpm-ostree` works with Silverblue:
...
![Screenshot permissions](https://www.privacyguides.org/en/assets/img/linux/screenshot_permission.png)

GNOME's screenshot permission dialog

Many alternatives don't provide these same permission controls yet,[1](https://www.privacyguides.org/en/os/linux-overview/#fn:1) while some are waiting for Wayland to implement these controls upstream.[2](https://www.privacyguides.org/en/os/linux-overview/#fn:2)
...
Optionally, changing the connection parameter from `random` to `stable` will give you a random MAC address _per network_, but keep it stable for that network when you reconnect to it later. Using `random` will give you a random MAC address _per connection_. This may be desirable for networks with captive portals or where you have a static DHCP assignment, at the expense of making you more identifiable by a single network operator you connect to multiple times.
...
There are other system identifiers which you may wish to be careful about. You should give this some thought to see if it applies to your [threat model](https://www.privacyguides.org/en/basics/threat-modeling/):
...
1. KDE currently has an open proposal to add controls for screen captures: [https://invent.kde.org/plasma/xdg-desktop-portal-kde/-/issues/7](https://invent.kde.org/plasma/xdg-desktop-portal-kde/-/issues/7) [↩](https://www.privacyguides.org/en/os/linux-overview/#fnref:1)

2. Sway is waiting to add specific security controls until they "know how security as a whole is going to play out" in Wayland: [https://github.com/swaywm/sway/issues/5118#issuecomment-600054496](https://github.com/swaywm/sway/issues/5118#issuecomment-600054496) [↩](https://www.privacyguides.org/en/os/linux-overview/#fnref:2)
