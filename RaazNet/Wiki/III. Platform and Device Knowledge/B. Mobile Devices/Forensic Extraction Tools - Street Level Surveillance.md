...
topics: ["Digital Security", "Law Enforcement Technology", "Mobile Device Privacy", "Civil Liberties"]
summary: "EFF guide explaining how police use forensic tools to extract data from mobile devices, the privacy threats they pose, and how to protect yourself."
...
- [Not unlocking your phone](https://ssd.eff.org/module/attending-protest) when [police pressure you](https://www.eff.org/deeplinks/2021/01/so-called-consent-searches-harm-our-digital-rights) to do so
...
After extraction, forensic tools can be coupled with workstation software to generate reports that are easily read and suitable for submission as evidence in court.
...
- **Location data**: Stored information from map applications
- **Calendar**: Events and appointments
- **Web activity**: Browsing history
- **Financial information**: Digital wallets and payment methods

> **Important**: In some cases, an advanced physical extraction can recover content that the user thought they "deleted" but was still stored on the device.
...
Forensic tools are [widely deployed](https://www.upturn.org/work/mass-extraction/) by law enforcement across multiple levels:
...
While hacking methods are not uncommon to unlock a phone, police may simply [ask you to unlock it](https://www.eff.org/deeplinks/2021/01/so-called-consent-searches-harm-our-digital-rights) to gain access. Once unlocked, all bets are off: the contents of your phone can be read manually by the officer, or the device can be plugged into a forensic extraction tool for comprehensive analysis.
...
Once a report is generated, police can submit it as evidence in court or use it to further their investigations. Often data is stored for months or years on a workstation, creating risk of data breach or misuse by officers with ill intentions.
...
- **Initial focus**: iOS extraction (now expanded to Android)
- **Main product**: [GrayKey](https://www.forbes.com/sites/thomasbrewster/2018/03/05/apple-iphone-x-graykey-hack/)
- **Pricing**: $15,000 for 300-use license; $30,000 for unlimited-use license
...
The powerful and invasive ability to do forensic imaging of mobile devices is becoming more widespread, and increasingly available to even small police departments and sheriff's offices.

## Threats Posed by Forensic Tools

### 1. Privacy Invasion

Forensic tools can vacuum and automatically scrutinize all of the information in our devices, exposing every aspect of our digital lives.
...
### 3. Disparate Impact on Vulnerable Communities

Forensic tools will disproportionately burden people of color, immigrants, and other vulnerable groups. Police unfairly subject these communities to a [disparately large share](https://www.ppic.org/publication/racial-disparities-in-law-enforcement-stops/) of traffic stops and sidewalk stops, and to a disparately large share of searches during those encounters. Forensic tools become the newest layer of this discriminatory stack.
