[Skip to content](https://www.privacyguides.org/en/os/ios-overview/#privacy-notes)

[Edit this page](https://github.com/privacyguides/privacyguides.org/blob/main/docs/os/ios-overview.md?plain=1 "Edit this page")
...
We generally consider iOS to provide better than average privacy and security protections for most people, compared to stock Android devices from any manufacturer. However, you can achieve even higher standards of privacy with a [custom Android operating system](https://www.privacyguides.org/en/android/distributions/) like GrapheneOS, if you want or need to be completely independent of Apple or Google's cloud services.
...
The encryption used by Advanced Data Protection, while strong, [is not _quite_ as robust](https://discuss.privacyguides.net/t/apple-advances-user-security-with-powerful-new-data-protections/10778/4) as the encryption offered by other [cloud services](https://www.privacyguides.org/en/cloud/), particularly when it comes to iCloud Drive. While we strongly encourage using Advanced Data Protection if you use iCloud, we would also suggest considering finding an alternative to iCloud from a more [privacy-focused service provider](https://www.privacyguides.org/en/tools/), although it is unlikely most people would be impacted by these encryption quirks.
...
A paid **iCloud+** subscription (with any iCloud storage plan) comes with some privacy-protecting functionality. While these may provide adequate service for current iCloud customers, we wouldn't recommend purchasing an iCloud+ plan over a [VPN](https://www.privacyguides.org/en/vpn/) and [standalone email aliasing service](https://www.privacyguides.org/en/email-aliasing/) just for these features alone.
...
Select **Turn Passcode On** or **Change Passcode** → **Passcode Options** → **Custom Alphanumeric Code**. Make sure that you create a [secure password](https://www.privacyguides.org/en/basics/passwords-overview/).
...
If you use biometrics, you should know how to turn them off quickly in an emergency. Holding down the side or power button and _either_ volume button until you see the Slide to Power Off slider will disable biometrics, requiring your passcode to unlock. Your passcode will also be required after device restarts.
...
Normal phone calls made with the Phone app through your carrier are not E2EE. Both FaceTime Video and FaceTime Audio calls are E2EE. Alternatively, you can use [another app](https://www.privacyguides.org/en/real-time-communication/) like Signal for E2EE calls.
...
![Photo Permissions](https://www.privacyguides.org/en/assets/img/ios/photo-permissions-light.png#only-light)![Photo Permissions](https://www.privacyguides.org/en/assets/img/ios/photo-permissions-dark.png#only-dark)
...
![Private Access](https://www.privacyguides.org/en/assets/img/ios/private-access-light.png#only-light)![Private Access](https://www.privacyguides.org/en/assets/img/ios/private-access-dark.png#only-dark)

Some apps also support **Private Access**, which functions similarly to the **Limited Access** permission. However, photos shared to apps using Private Access include their location by default. We recommend unchecking this setting if you do not [remove photo metadata](https://www.privacyguides.org/en/data-redaction/) beforehand.
...
![Contact Permissions](https://www.privacyguides.org/en/assets/img/ios/contact-permissions-light.png#only-light)![Contact Permissions](https://www.privacyguides.org/en/assets/img/ios/contact-permissions-dark.png#only-dark)
...
Our warning [against blurring text](https://www.privacyguides.org/en/data-redaction/) also applies here, so we recommend to instead add a black shape with 100% opacity over it. In addition to redacting text, you can also black out any face or object using the **Photos** app.
...
If your threat model includes [Targeted Attacks](https://www.privacyguides.org/en/basics/common-threats/#attacks-against-specific-individuals) that involve forensic tools, and you want to minimize the chance of exploits being used to access your phone, you should restart your device frequently. The state _after_ a reboot but _before_ unlocking your device is referred to as "Before First Unlock" (BFU), and when your device is in that state it makes it [significantly more difficult](https://belkasoft.com/checkm8_glossary) for forensic tools to exploit vulnerabilities to access your data. This BFU state allows you to receive notifications for calls, texts, and alarms, but most of the data on your device is still encrypted and inaccessible. This can be impractical, so consider whether these trade-offs make sense for your situation.
