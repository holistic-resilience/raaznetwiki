...
Proton VPN has their [Stealth](https://protonvpn.com/blog/stealth-vpn-protocol) protocol which _may_ help in situations where VPN protocols like OpenVPN or WireGuard are blocked with various rudimentary techniques. Stealth encapsulates the VPN tunnel in TLS session in order to look like more generic internet traffic.
...
Proton VPN clients support two-factor authentication on all platforms. Proton VPN has their own servers and datacenters in Switzerland, Iceland and Sweden. They offer content blocking and known-malware blocking with their DNS service. Additionally, Proton VPN also offers "Tor" servers allowing you to easily connect to onion sites, but we still strongly recommend using [the official Tor Browser](https://www.privacyguides.org/en/tor/#tor-browser) for this purpose.

##### Kill switch feature is broken on Intel-based Macs
...
- [Google Play](https://play.google.com/store/apps/details?id=net.ivpn.client)
- [App Store](https://apps.apple.com/app/id1193122683)
- [Accrescent](https://accrescent.app/app/net.ivpn.client)
- [GitHub](https://github.com/ivpn/android-app/releases)
- [Windows](https://ivpn.net/apps-windows)
- [macOS](https://ivpn.net/apps-macos)
- [Linux](https://ivpn.net/apps-linux)

#### 37 Countries

IVPN has [servers in 37 countries](https://ivpn.net/status).
...
- [App Store](https://apps.apple.com/app/id1488466513)
...
Mullvad has [servers in 49 countries](https://mullvad.net/servers).
...
- [Anonymous cryptocurrency](https://www.privacyguides.org/en/cryptocurrency/) **or** cash payment option.
- No personal information required to register: Only username, password, and email at most.

**Best Case:**

- Accepts multiple [anonymous payment options](https://www.privacyguides.org/en/advanced/payments/).
...
- An accurate comparison to when [Tor](https://www.privacyguides.org/en/tor/) should be used instead.
