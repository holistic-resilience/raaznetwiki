[Skip to content](https://www.privacyguides.org/en/data-broker-removals/#manual-opt-outs-free)

![](https://www.privacyguides.org/en/assets/img/cover/data-broker-removals.webp)

# Data Removal Services

[Edit this page](https://github.com/privacyguides/privacyguides.org/blob/main/docs/data-broker-removals.md?plain=1 "Edit this page")
...
Be sure to avoid burning out or becoming overwhelmed with this process. Unless you're in immediate danger, you can take breaks and avoid doing them all at once.[1](https://www.privacyguides.org/en/data-broker-removals/#fn:1)
...
Once you have opted-out of all of these sites for the first time, it's best to wait a week or two for the requests to propagate to all their sites. Then, you can start to search and opt-out of any remaining sites you find. It can be a good idea to use a web crawler like [Google's _Results about you_](https://www.privacyguides.org/en/data-broker-removals/#google-results-about-you-free) tool to help find any data that remains on the internet.
...
![EasyOptOuts logo](https://www.privacyguides.org/en/assets/img/data-broker-removals/easyoptouts.svg)
...
[Homepage](https://easyoptouts.com/) [Privacy Policy](https://easyoptouts.com/privacy "Privacy Policy")
...
![Google logo](https://www.privacyguides.org/en/assets/img/data-broker-removals/google.svg)
...
[Open Web Tool](https://myactivity.google.com/results-about-you) [Documentation](https://support.google.com/websearch/answer/12719076 "Documentation")
...
1. If you _are_ immediately threatened by stalkers or other threats, you should strongly consider an automated tool like [EasyOptOuts](https://www.privacyguides.org/en/data-broker-removals/#easyoptouts-paid), at least for the initial "purge." When things are more manageable in the future you can come back to the manual process. Of course, in a dangerous situation your first priority should always be to seek professional help [from police](https://onlineharassmentfieldmanual.pen.org/involving-law-enforcement) or others before tackling it on your own. [↩](https://www.privacyguides.org/en/data-broker-removals/#fnref:1)
