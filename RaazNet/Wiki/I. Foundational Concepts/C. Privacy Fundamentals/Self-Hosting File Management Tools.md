...
summary: "Overview of self-hosted file management solutions including PhotoPrism, FreedomBox, and Nextcloud for privacy-focused file storage and sharing."
...
**PhotoPrism** is a platform for managing photos. It supports album syncing and sharing as well as a variety of other features.
...
- [Features](https://photoprism.app/features)
...
| Platform | Link |
|----------|------|
| Android (Google Play) | [Download](https://play.google.com/store/apps/details?id=com.nextcloud.client) |
| Android (GitHub) | [Download](https://github.com/nextcloud/android/releases) |
| iOS | [Download](https://apps.apple.com/app/id1125420102) |
