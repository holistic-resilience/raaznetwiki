[Skip to content](https://freedom.press/digisec/blog/choosing-a-password-manager/#main)

![](https://media.freedom.press/media/images/combination_lock.2e16d0ba.fill-1920x1080.jpg)

[Photo by Doug Focht](https://flic.kr/p/3BEauj). CC BY-NC-ND 2.0

Also available [in Spanish](https://freedom.press/digisec/blog/como-elegir-un-gestor-de-contrasenas/).

As password breaches become [more frequent](https://www.wired.com/story/wired-guide-to-data-breaches/), learning how to protect online accounts is more important than ever.
...
Password breaches happen [all the time](https://haveibeenpwned.com/), and because hackers know you’re likely reusing passwords, they’ll try your credentials on multiple websites. The safest thing to do is use unique passwords on each website. At the same time, it feels hard to remember more than a handful of passwords. So what do you do?
...
## [Jump link for section](https://freedom.press/digisec/blog/choosing-a-password-manager/\#what-to-look-for-in-a-password-manager)**What to look for in a password manager**
...
Many password managers ( [1Password](https://1password.com/), [Dashlane](https://dashlane.com/), [Bitwarden](https://bitwarden.com/)) have online services that allow users to keep remote copies of their password vaults. This can be helpful for keeping information synced across multiple devices, and for the assurance that you can access your vault again if you lose a device.
...
One example of a password manager with a track record of active development is 1Password, which has promptly issued security patches and pushed new features to adapt to new hardware, such as [fingerprint readers](https://support.1password.com/android-biometric-unlock/), that were built into newer desktop devices.
...
## [Jump link for section](https://freedom.press/digisec/blog/choosing-a-password-manager/\#dispelling-password-manager-myths) Dispelling password manager myths
...
## [Jump link for section](https://freedom.press/digisec/blog/choosing-a-password-manager/\#the-short-version) The short version
...
- [1Password](https://1password.com/) ( [pricing options](https://1password.com/sign-up/), or free to journalists through the [1Password for Journalism](https://1password.com/for-journalism/) program)
- [Dashlane](https://www.dashlane.com/) ( [pricing options](https://www.dashlane.com/pricing))
- [Bitwarden](https://bitwarden.com/) (Free, or see [pricing options](https://bitwarden.com/pricing/) for extra features such as encrypted storage and two-factor authentication with security keys)

We’re also fans of the free and open source [KeePassXC](https://keepassxc.org/) project. There are many [related projects](https://keepass.info/) with similar names and functionality, but KeePassXC is being actively developed and supports multiple platforms with up-to-date features. It’s also one of the few reliable password management options that allow you to keep passwords entirely offline, if you prefer not to use third party services to keep passwords syncing across devices.

Our digital security trainers assist members of the press in getting set up with an airtight account security practice. [Contact our trainers](https://freedom.press/training/request-training/) to learn more about our educational offerings.
